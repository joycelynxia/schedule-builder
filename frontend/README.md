...
- edit schedule
- repeat schedule/set pattern (recurrence - see google for reference)
- drag to create schedule

Schedule (user/employee)
- toggle between only me vs everyone

Unavailability (same for manager and employee)
- assume available unless unavailability is added
- declare single day or multiple - repeat/pattern
